...
import { addAppointment, customerLogin, customerLogout, customerProfile, customerRegister } from "../Request/api";
...
export const UserAuthContextProvider = ({ children }) => {
  ...
  return (
    <UserAuthContext.Provider value={{ user, setUser, loginUser, logoutUser, userProfile, registerUser, appointmentAdd }}>
      { children }
